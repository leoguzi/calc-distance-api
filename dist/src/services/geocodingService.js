...
exports.getAddressCoordinates = void 0;
...
function getAddressCoordinates(address) {
    return __awaiter(this, void 0, void 0, function () {
        var querryString, response, foundedAddress;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    querryString = buildQuery(address);
                    return [4 /*yield*/, axios_1["default"].get("".concat(API_URL).concat(querryString, "&key=").concat(API_KEY))];
                case 1:
                    response = _a.sent();
                    foundedAddress = response.data.results[0];
                    if (!foundedAddress) {
                        throw new AddressNotFound_1["default"]();
                    }
                    return [2 /*return*/, __assign(__assign({}, address), { formattedAddress: foundedAddress.formatted_address, location: foundedAddress.geometry.location })];
            }
        });
    });
}
